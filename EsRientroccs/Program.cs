            ...
            do
            {
                ...
                switch (scelta)
                {
                    ...
                    case 2:
                        ...
                        {
                            Console.WriteLine("Effettua prima l'aggiustamento del file (1) per continuare...");
                            Console.WriteLine("Clicca un tasto per continuare...");
                            Console.ReadLine();
                        }
                        break;
                    ...
                    case 5:
                        if (l.ContrAgg())
                        {
                            ...
                            string[] array = l.EstrapolaCampi(cvis[0], cvis[1], cvis[2], true);
                            int f = 0;
                            while (array[f] != null)
                            {
